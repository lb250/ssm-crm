...
<script type="text/javascript">
	...
	$(function(){
		$("#relationedTBody").on("click","a",function () {
			...
			var clueId='${clue.id}';
			$.ajax({
				url:"workbench/clue/deleteActivityClueRelation.do",
				data:{
		...
		$("#addRelationBtn").click(function () {
			...
			ids+="clueId=${clue.id}";
			$.ajax({
				url:"workbench/clue/addActivityClueRelation.do",
				data:ids,
				dataType:"json",
				type:"post",
				success:function (data) {
		...
		$("#aCreateRelationBtn").click(function () {
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input id="iActivityName" type="text" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button id="convertBtn" type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.do?clueId=${clue.id}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a id="aCreateRelationBtn" href="javascript:void(0);"  style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
